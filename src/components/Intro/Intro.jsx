  ...
  return (
    <motion.div className="intro"
      ...
      <div className="intro-text">
        ...
        1996 yili Koson tumanidagi 9-sonli maktabni oltin medal bilan tamomlab, Qashqadaryo viloyat Qarshi Davlat
        universitetiga, "Amaliy matematika va informatika" fakultetiga, byudjet asosida o`qishga qabul qilingan.
        2000 yildan Koson tumanidagi 1-2-9-92-maktablarda informatika va AT fani o`qituvchisi lavosimida faoliyat
        yuritgan. <br/>
        ...
        Hozirda Koson tuman 9-maktabda Informatika va AT fani o`qituvchisi lavozimida faoliyat yuritadi.
